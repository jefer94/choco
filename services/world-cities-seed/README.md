<div align="center">
  ...
  <a href="https://github.com/jefer94/choco">
    <img
      width="400"
      src="https://img.shields.io/badge/choco-seed-green.svg?style=for-the-badge&colorA=21252b&colorB=568af2"
    />
  </a>
  ...
  [![docker pulls](https://img.shields.io/docker/pulls/chocolab/world-cities-seed)](https://hub.docker.com/repository/docker/chocolab/world-cities-seed)
  [![docker starts](https://img.shields.io/docker/stars/chocolab/world-cities-seed)](https://hub.docker.com/repository/docker/chocolab/world-cities-seed)
  [![docker version](https://img.shields.io/docker/v/chocolab/world-cities-seed)](https://hub.docker.com/repository/docker/chocolab/world-cities-seed)

  <br>
  <h1>Choco world cities seed</h1>
  <p>Countries, cities and language database seed.</p>
</div>
...
```bash
# Run in docker
docker-compose up -d world-cities-seed
```
