...
function ConsoleLine(_ref) {
  ...
  return /*#__PURE__*/React.createElement(LineWrapper, {
    theme: theme
  }, lineNumber === 0 ? /*#__PURE__*/React.createElement(Line, {
    as: "p",
    firstLine: true
  }, "~ \u03BB") : '', /*#__PURE__*/React.createElement(Line, null, line.content ? /*#__PURE__*/React.createElement("p", null, line.content) : '', line["var"] ? /*#__PURE__*/React.createElement("p", {
    className: "var"
  }, line["var"]) : ''));
}
...
function Console(_ref) {
  ...
  return /*#__PURE__*/React.createElement("main", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: line.id
    }, /*#__PURE__*/React.createElement(ConsoleLine, {
      line: line,
      lineNumber: key,
      theme: theme
...
function CodemirrorWrapper(_ref) {
  ...
  return (
    ...
    React.createElement(UnControlled, {
...
function Editor(_ref) {
  ...
  var _useState = useState(windowHeight()),
      _useState2 = _slicedToArray(_useState, 2),
      height = _useState2[0],
      setHeight = _useState2[1];

  var _useState3 = useState(windowWidth()),
...
var Icon$1 = styled(Icon)(_templateObject$4(), function (v) {
  return v.theme.white;
});
...
function Link(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ServerLink, {
    href: to
  }, children);
}
Link.propTypes = {
...
function MenuItem(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("li", {
    className: className,
    onClick: onClick
  }, /*#__PURE__*/React.createElement(MenuLinkStyled, {
    url: url,
    icon: icon,
    active: active,
    theme: theme
...
var MenuItem$1 = styled(MenuItem)(_templateObject2$1(), BaseStyled, function (v) {
  return v.active ? 'brightness(150%)' : 'unset';
});
...
function Menu(_ref) {
  var theme = _ref.theme,
      ...
      isOpen = _ref.isOpen,
      toggle = _ref.toggle;
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(MenuWrapper, {
    theme: theme,
    show: isOpen
  }, /*#__PURE__*/React.createElement("ul", null, /*#__PURE__*/React.createElement(MenuItem$1, {
    icon: faBars,
    active: true,
    theme: theme,
...
function CloseTab(_ref) {
  var theme = _ref.theme,
      name = _ref.name,
      remove = _ref.remove;
  return remove ? /*#__PURE__*/React.createElement(TabButton, {
...
function TitleAndSelectTab(_ref2) {
  var theme = _ref2.theme,
      name = _ref2.name,
      change = _ref2.change;
  return change ? /*#__PURE__*/React.createElement(TabButton, {
    label: "Change to: ".concat(name),
    click: change,
    theme: theme
  }, name) : /*#__PURE__*/React.createElement(TabButton, {
...
function Tab(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(InnerLi, {
    theme: theme
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(TitleAndSelectTab, {
    name: name,
    id: id,
    change: change,
    theme: theme
...
function AddTabButton(_ref) {
  var theme = _ref.theme,
      add = _ref.add;
  return add ? /*#__PURE__*/React.createElement(SimpleButtonLi, null, /*#__PURE__*/React.createElement(SimpleTabButton, {
    onClick: add,
    onKeyUp: add,
    label: "Add tab",
    theme: theme
...
function Tabs(_ref2) {
  ...
  return /*#__PURE__*/React.createElement(Nav, {
    ...
    theme: theme
  }, /*#__PURE__*/React.createElement(SimpleButtonLi, {
    id: "hamburger"
  }, /*#__PURE__*/React.createElement(Link, {
    to: "/console"
  }, /*#__PURE__*/React.createElement(SimpleTabButton, {
    label: "Menu",
    theme: theme
  }, /*#__PURE__*/React.createElement(Icon$1, {
    name: faBars,
    ...
    ;
  }), /*#__PURE__*/React.createElement(AddTabButton, {
    add: add,
    theme: theme
  })));
}
...
export { Button, Console, ConsoleLine, Docs, Editor, FloatingButtonStyled as FloatingButton, Icon$1 as Icon, Link, LoadingStyled as Loading, Menu, MenuItem$1 as MenuItem, Tab, TabButton, Tabs };
