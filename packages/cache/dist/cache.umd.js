(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('express'), require('body-parser'), require('redis'), require('util'), require('@services/express-common')) :
  typeof define === 'function' && define.amd ? define(['express', 'body-parser', 'redis', 'util', '@services/express-common'], factory) :
  (global = global || self, factory(global.express, global.bodyParser, global.redis, global.util, global.common));
}(this, (function (express, bodyParser, redis, util, common) { 'use strict';
